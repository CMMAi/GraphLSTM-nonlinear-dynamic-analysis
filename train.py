...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--train_split_ratio", type=list, default=[0.50, 0.25, 0.25])
    ...
    parser.add_argument("--graph_lstm_hidden_dim", type=int, default=64)
    parser.add_argument("--graph_lstm_num_layers", type=int, default=1)
    parser.add_argument("--node_lstm_hidden_dim", type=int, default=64)
...
def main(args):
    ...
    if args.pretrain != None:
        pretrain_path = Path("../Results/") / args.pretrain
